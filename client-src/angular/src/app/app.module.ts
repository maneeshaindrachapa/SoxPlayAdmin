...
import {SDKBrowserModule, StorageBrowser} from './services/sdk';
...
import {InternalStorage} from 'src/app/services/sdk/storage/storage.swaps';

const appRoutes: Routes = [
  {path: '', component: SigninComponent},
  {path: 'dashboard', component: DashboardComponent, canActivate: [AuthGuardService]},
  {path: 'items', component: ItemsEditDeleteComponent, canActivate: [AuthGuardService]},
  {path: 'theme', component: ThemeFullComponent, canActivate: [AuthGuardService]},
  {path: 'users', component: UserFullComponent, canActivate: [AuthGuardService]},
  {path: 'maps', component: MapsFullComponent, canActivate: [AuthGuardService]}
];
